...
namespace Tempo\Bundle\ResourceExtraBundle\Twig\Extension;
...
class ResourceExtension extends \Twig_Extension
{
     ...
     */
    public function __construct(RouterInterface $router, array $templates)
    {
        $this->router = $router;
    ...
    public function renderSortingLink(\Twig_Environment $twig, $property, $label = null, $order = 'asc', array $options = array())
    {
        ...
        $options = $this->getOptions($options, $this->templates['sorting']);
